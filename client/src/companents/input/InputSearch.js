...
const InputSearch = ({ valueSearch, setValueSearch, placeholder = "Tìm kiếm" }) => {
    const { IoClose } = icons
    ...
    return (
        <div className='flex'>
            <input 
                ...
                className='bg-[#F3F4F6] w-[250px] py-2 pl-2 outline-none rounded-l-md' placeholder={placeholder}
            ></input>
